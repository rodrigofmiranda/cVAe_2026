...
def _preset_seq_flow_smoke() -> List[Dict[str, Any]]:
    """Single-candidate smoke for the first conditional flow decoder."""

    return [
        dict(
            group="F0_seq_flow_smoke",
            tag="F0seq_W7_h64_lat4_flow_b0p002_lmmd0p25_axis0_fb0p10_lr0p0002_L128-256-512",
            cfg=_cfg(
                arch_variant="seq_bigru_residual",
                layer_sizes=[128, 256, 512],
                latent_dim=4,
