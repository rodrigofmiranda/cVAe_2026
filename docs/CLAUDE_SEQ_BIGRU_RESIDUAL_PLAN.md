...
- load this plan through the project memory file [CLAUDE.md](/workspace/2026/feat_delta_residual_adv/CLAUDE.md)
- keep review-only criteria in [REVIEW.md](/workspace/2026/feat_delta_residual_adv/REVIEW.md)
- use shared project settings in [.claude/settings.json](/workspace/2026/feat_delta_residual_adv/.claude/settings.json)
  so Claude starts in Plan Mode for this branch by default
- use path-scoped rules in [.claude/rules/seq-invariants.md](/workspace/2026/feat_delta_residual_adv/.claude/rules/seq-invariants.md)
...
1. launch from `/workspace/2026/feat_delta_residual_adv`
...
1. [PROJECT_STATUS.md](/workspace/2026/feat_delta_residual_adv/PROJECT_STATUS.md)
2. [TRAINING_PLAN.md](/workspace/2026/feat_delta_residual_adv/TRAINING_PLAN.md)
3. [docs/PROTOCOL.md](/workspace/2026/feat_delta_residual_adv/docs/PROTOCOL.md)
4. [src/models/cvae.py](/workspace/2026/feat_delta_residual_adv/src/models/cvae.py)
5. [src/data/loading.py](/workspace/2026/feat_delta_residual_adv/src/data/loading.py)
6. [src/protocol/split_strategies.py](/workspace/2026/feat_delta_residual_adv/src/protocol/split_strategies.py)
7. [src/training/pipeline.py](/workspace/2026/feat_delta_residual_adv/src/training/pipeline.py)
8. [src/training/grid_plan.py](/workspace/2026/feat_delta_residual_adv/src/training/grid_plan.py)
9. [src/config/defaults.py](/workspace/2026/feat_delta_residual_adv/src/config/defaults.py)
10. [src/config/schema.py](/workspace/2026/feat_delta_residual_adv/src/config/schema.py)
11. [src/protocol/run.py](/workspace/2026/feat_delta_residual_adv/src/protocol/run.py)
12. [src/evaluation/engine.py](/workspace/2026/feat_delta_residual_adv/src/evaluation/engine.py)
...
- [src/config/defaults.py](/workspace/2026/feat_delta_residual_adv/src/config/defaults.py)
- [src/config/schema.py](/workspace/2026/feat_delta_residual_adv/src/config/schema.py)
- [src/models/cvae.py](/workspace/2026/feat_delta_residual_adv/src/models/cvae.py)
- new file recommended: [src/models/cvae_sequence.py](/workspace/2026/feat_delta_residual_adv/src/models/cvae_sequence.py)
- new file recommended: [src/data/windowing.py](/workspace/2026/feat_delta_residual_adv/src/data/windowing.py)
- [src/training/pipeline.py](/workspace/2026/feat_delta_residual_adv/src/training/pipeline.py)
- [src/training/grid_plan.py](/workspace/2026/feat_delta_residual_adv/src/training/grid_plan.py)
- [src/evaluation/engine.py](/workspace/2026/feat_delta_residual_adv/src/evaluation/engine.py)
- [src/protocol/run.py](/workspace/2026/feat_delta_residual_adv/src/protocol/run.py)
- tests to add under `/workspace/2026/feat_delta_residual_adv/tests/`

Files to read but preferably avoid editing unless necessary:

- [src/data/loading.py](/workspace/2026/feat_delta_residual_adv/src/data/loading.py)
- [src/protocol/split_strategies.py](/workspace/2026/feat_delta_residual_adv/src/protocol/split_strategies.py)
