...
| --- | --- | --- | --- | --- |
| `algo1` | `algo1` | `cvae_algo1` | `/home/rodrigo/cVAe_2026_full_square` | `/workspace/2026/feat_seq_bigru_residual_cvae` |
| `algo2` | `algo2` | `cvae_algo2` | `/home/rodrigo/cVAe_2026_full_circle` | `/workspace/2026/feat_seq_bigru_residual_cvae` |
...
- [canonical_dual_run.sh](/home/rodrigo/cVAe_2026/scripts/ops/canonical_dual_run.sh)
...
```bash
/home/rodrigo/cVAe_2026/scripts/ops/canonical_dual_run.sh status
```
...
```bash
/home/rodrigo/cVAe_2026/scripts/ops/canonical_dual_run.sh enter algo1
/home/rodrigo/cVAe_2026/scripts/ops/canonical_dual_run.sh enter algo2
```
...
```bash
/home/rodrigo/cVAe_2026/scripts/ops/canonical_dual_run.sh send algo1 -- pwd
/home/rodrigo/cVAe_2026/scripts/ops/canonical_dual_run.sh send algo2 -- git branch --show-current
```
...
```bash
/home/rodrigo/cVAe_2026/scripts/ops/canonical_dual_run.sh run <algo1|algo2> <run_tag> -- <comando...>
```

Exemplo:

```bash
/home/rodrigo/cVAe_2026/scripts/ops/canonical_dual_run.sh run algo1 e2_full -- \
...
```bash
/home/rodrigo/cVAe_2026/scripts/ops/canonical_dual_run.sh run algo2 eval16qam_disk -- \
...
- `algo1`: `/home/rodrigo/cVAe_2026_full_square`
- `algo2`: `/home/rodrigo/cVAe_2026_full_circle`
