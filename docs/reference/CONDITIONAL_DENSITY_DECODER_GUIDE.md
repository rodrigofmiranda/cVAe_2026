...
- [archive/active/MDN_G5_RECOVERY_PLAN.md](/workspace/2026/feat_seq_bigru_residual_mdn_route/docs/archive/active/MDN_G5_RECOVERY_PLAN.md)
- [archive/agents/CLAUDE_SEQ_BIGRU_RESIDUAL_PLAN.md](/workspace/2026/feat_seq_bigru_residual_mdn_route/docs/archive/agents/CLAUDE_SEQ_BIGRU_RESIDUAL_PLAN.md)
