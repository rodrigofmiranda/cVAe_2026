...
- [active/WORKING_STATE.md](/workspace/2026/feat_seq_bigru_residual_spline_flow_v2/docs/active/WORKING_STATE.md)

## Reference Docs

- [reference/PROTOCOL.md](/workspace/2026/feat_seq_bigru_residual_spline_flow_v2/docs/reference/PROTOCOL.md)
- [reference/MODELING_ASSUMPTIONS.md](/workspace/2026/feat_seq_bigru_residual_spline_flow_v2/docs/reference/MODELING_ASSUMPTIONS.md)
...
- [agents/REVIEW.md](/workspace/2026/feat_seq_bigru_residual_spline_flow_v2/docs/agents/REVIEW.md)

## Operations

- [operations/HOST_GPU_IDLE_DIAGNOSTIC.md](/workspace/2026/feat_seq_bigru_residual_spline_flow_v2/docs/operations/HOST_GPU_IDLE_DIAGNOSTIC.md)

## Archive

- [archive/README.md](/workspace/2026/feat_seq_bigru_residual_spline_flow_v2/docs/archive/README.md)
