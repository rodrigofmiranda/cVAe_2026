        ...
        [
            {
                ...
                "epochs_ran": 60,
                "best_epoch": 45,
                "best_epoch_ratio": 0.56,
                "epochs_since_best": 15,
                "best_val_recon_loss": -3.9,
                "last_val_recon_loss": -3.8,
                "train_recon_at_best": -4.1,
                "train_recon_last": -4.0,
                "final_lr": 1e-6,
                "lr_drop_count": 4,
                "late_val_slope": -5e-5,
                "late_val_std": 0.01,
            ...
            },
            {
                ...
                "layer_sizes": [128, 256, 512],
                "window_size": np.nan,
                "seq_hidden_size": np.nan,
                "lambda_mmd": 0.0,
                "epochs_ran": 54,
                "best_epoch": 46,
                "best_epoch_ratio": 0.57,
                "epochs_since_best": 8,
                "best_val_recon_loss": -3.7,
                "last_val_recon_loss": -3.6,
                "train_recon_at_best": -4.0,
                "train_recon_last": -3.9,
                "final_lr": 1e-6,
                "lr_drop_count": 5,
                "late_val_slope": -2e-4,
                "late_val_std": 0.08,
                "active_dims": 2,
                "active_dim_ratio": 0.33,
                "kl_mean_total": 0.4,
                "kl_mean_per_dim": 0.05,
                "score_v2": 1.8,
                "delta_evm_%": 0.8,
                "delta_snr_db": -0.6,
                "delta_mean_l2": 0.08,
