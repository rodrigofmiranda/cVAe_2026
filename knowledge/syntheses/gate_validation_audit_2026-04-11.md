...
- thresholds: [validation_summary.py](/home/rodrigo/cVAe_2026_shape/src/evaluation/validation_summary.py)
- stat-test suite: [stat_tests/__init__.py](/home/rodrigo/cVAe_2026_shape/src/evaluation/stat_tests/__init__.py)
- MMD test: [mmd.py](/home/rodrigo/cVAe_2026_shape/src/evaluation/stat_tests/mmd.py)
- Energy test: [energy.py](/home/rodrigo/cVAe_2026_shape/src/evaluation/stat_tests/energy.py)
- FDR correction: [fdr.py](/home/rodrigo/cVAe_2026_shape/src/evaluation/stat_tests/fdr.py)
- direct evaluation path: [engine.py](/home/rodrigo/cVAe_2026_shape/src/evaluation/engine.py)
- protocol path: [run.py](/home/rodrigo/cVAe_2026_shape/src/protocol/run.py)
...
- [askari_lampe_2025_probabilistic_shaping_nonlinearity_tolerance.md](/home/rodrigo/cVAe_2026_shape/knowledge/notes/askari_lampe_2025_probabilistic_shaping_nonlinearity_tolerance.md)
- [shu_2020_probabilistic_shaping_optical.md](/home/rodrigo/cVAe_2026_shape/knowledge/notes/shu_2020_probabilistic_shaping_optical.md)
- [vlc_shaping_experimental_methodology_2026-04-03.md](/home/rodrigo/cVAe_2026_shape/knowledge/syntheses/vlc_shaping_experimental_methodology_2026-04-03.md)
...
The code already hints at this:

- some future gates are explicitly marked as pending empirical calibration
- archived notes already flagged that `JB` is sensitive to sample size and may
  need recalibration

So `G5` is useful, but it clearly belongs in the "domain-calibrated
engineering criterion" bucket.
...
- thresholds (`10%`) appear hard-coded
- no explicit calibration memo was found showing why `10%` is the right
  acceptance boundary for this bench
...
- still threshold-based, with no explicit calibration report found
...
- again, threshold looks project-defined rather than literature-derived
...
The external references support the current ingredients, but also support a
...
- `G6 tests whether the measured and generated residual samples show no
  statistically detected mismatch under MMD and Energy tests after FDR
  correction.`
...
- Rizzo and Székely (2016), *Energy distance*.
...
- Wasserstein/engineering validation framing:
